...
install() {
  ...
  [[ -d ${SCHEMES_DIR}/Aura.colors ]] && rm -r ${SCHEMES_DIR}/Aura.colors
  ...
  [[ ${color} == '' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/Aura.colors                                    ${SCHEMES_DIR} && \
  cp -ur ${SRC_DIR}/color-schemes/Aura.colors                                    ${PLASMA_DIR}/${name}/colors

  [[ ${color} == '-light' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/Aura.colors                               ${SCHEMES_DIR}
}

echo "Installing 'Aura kde themes'..."
